...
<tr><td>$ro[facilities]
</td><td valign='top'>R $ro[price]</td><td valign='top'>R $ro[singleSupp]</td></tr></table></p>
...
echo "<div class='row'><div class='col-12'><a class='btn btn-outline btn-secondary' href='booknow.php?id=$idx'>Book $title Now</a></div></div>";
include "footer.php";
